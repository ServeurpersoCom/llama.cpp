...
#define GGML_CUDA_CC_BLACKWELL_PRO   1220 // sm_122, RTX PRO 6000, block scaling support
...
#if !defined(GGML_USE_HIP) && __CUDA_ARCH__ >= GGML_CUDA_CC_BLACKWELL_PRO && __CUDA_ARCH__ < GGML_CUDA_CC_RUBIN
