...
uint32_t code2wav_sample_rate   (const code2wav_context * ctx);  // 24000
int      code2wav_n_quantizers  (const code2wav_context * ctx);  // 16
int      code2wav_total_upsample(const code2wav_context * ctx);  // 1920
